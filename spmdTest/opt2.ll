; ModuleID = './tmp-161214-1752-dAKTWI/pacxx.bc'
...
define spir_kernel void @"_ZN5pacxx2v213genericKernelILm0EZ4mainE12$_4028513607JPfS3_S3_iEEEvT0_DpNSt3__111conditionalIXsr3std12is_referenceIT1_EE5valueENS5_20add_lvalue_referenceINS0_17generic_to_globalIS7_E4typeEE4typeESB_E4typeE"(i8 %callable.coerce, float addrspace(1)* nocapture readonly %args, float addrspace(1)* nocapture readonly %args1, float addrspace(1)* nocapture %args2, i32 %args3) #0 {
  ...
  %7 = icmp ult i32 %4, %args3
  br i1 %7, label %8, label %"_ZZ4mainENK12$_4028513607clEPKfS1_Pfj.exit"
...
"_ZZ4mainENK12$_4028513607clEPKfS1_Pfj.exit":     ; preds = %0, %8
  ret void
}
