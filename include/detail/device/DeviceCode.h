...
extern "C" void __printf(const __attribute__((address_space(4))) char*, void* x);
...
template <typename T> struct extend_type {
  ...
  using type = typename std::conditional<
      ...
      typename std::conditional<std::is_same<T, float>::value, double, T>::type>::type;
};
...
#define __atomic_op_decl_(op, ctype, memory)                                                       \
  __forceinline__ ctype atomic_##op(memory##_mem_##ctype##_ptr ptr, ctype value);

#define atomic_decl_(op, ctype)                                                                    \
  __atomic_op_decl_(op, ctype, global) __atomic_op_decl_(op, ctype, shared)

atomic_decl_(add, int) atomic_decl_(add, uint) atomic_decl_(add, ulong) atomic_decl_(add, float)

atomic_decl_(min, int) atomic_decl_(min, uint) atomic_decl_(min, long) atomic_decl_(min, ulong)

atomic_decl_(max, int) atomic_decl_(max, uint) atomic_decl_(max, long)
...
atomic_decl_(exch, uint) atomic_decl_(exch, ulong)

atomic_decl_(and, uint) atomic_decl_(and, ulong) atomic_decl_(or, uint)
atomic_decl_(or, ulong) atomic_decl_ (xor, uint)
...
namespace native {
  ...
  namespace atomic {
...
#ifdef __device_code__
        return ::atomic_add((volatile __attribute__((address_space(1))) T*)ptr, value);
#else
        return T();
#endif
      }
...
#ifdef __device_code__
        return ::atomic_and((volatile __attribute__((address_space(1))) T*)ptr, value);
#endif
      }

      template <typename T> T atomic_or(T* ptr, T value) {
#ifdef __device_code__
        return ::atomic_or((volatile __attribute__((address_space(1))) T*)ptr, value);
#else
        return T();
#endif
      }
...
#ifdef __device_code__
        return ::atomic_xor((volatile __attribute__((address_space(1))) T*)ptr, value);
#else
        return T();
#endif
      }
...
#ifdef __device_code__
        return ::atomic_max((volatile __attribute__((address_space(1))) T*)ptr, value);
#else
        return T();
#endif
      }
...
#ifdef __device_code__
        return ::atomic_min((volatile __attribute__((address_space(1))) T*)ptr, value);
#else
        return T();
#endif
      }
    ...
    namespace shared {
      template <typename T> T atomic_add(T* ptr, T value) {
#ifdef __device_code__
        return ::atomic_add((volatile __attribute__((address_space(3))) T*)ptr, value);
#else
        return T();
#endif
      }
      ...
      template <typename T> T atomic_and(T* ptr, T value) {
#ifdef __device_code__
        return ::atomic_and((volatile __attribute__((address_space(3))) T*)ptr, value);
#else
        return T();
#endif
      }
      ...
      template <typename T> T atomic_or(T* ptr, T value) {
#ifdef __device_code__
        return ::atomic_or((volatile __attribute__((address_space(3))) T*)ptr, value);
#else
        return T();
#endif
      }
      ...
      template <typename T> T atomic_xor(T* ptr, T value) {
#ifdef __device_code__
        return ::atomic_xor((volatile __attribute__((address_space(3))) T*)ptr, value);
#else
        return T();
#endif
      }
      ...
      template <typename T> T atomic_max(T* ptr, T value) {
#ifdef __device_code__
        return ::atomic_max((volatile __attribute__((address_space(3))) T*)ptr, value);
#else
        return T();
#endif
      }
      ...
      template <typename T> T atomic_min(T* ptr, T value) {
#ifdef __device_code__
        return ::atomic_min((volatile __attribute__((address_space(3))) T*)ptr, value);
#else
        return T();
#endif
      }
