...
typedef volatile __attribute__((address_space(1))) unsigned int*  global_mem_uint_ptr;
typedef volatile __attribute__((address_space(1))) long*          global_mem_long_ptr;
typedef volatile __attribute__((address_space(1))) unsigned long* global_mem_ulong_ptr;
...
typedef volatile __attribute__((address_space(3))) unsigned int*  shared_mem_uint_ptr;
typedef volatile __attribute__((address_space(3))) long*          shared_mem_long_ptr;
typedef volatile __attribute__((address_space(3))) unsigned long* shared_mem_ulong_ptr;
